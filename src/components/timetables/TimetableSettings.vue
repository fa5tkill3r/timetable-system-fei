  ...
  <Popover>
    <PopoverTrigger as-child>
      <Button variant="outline" size="icon" class="h-8 w-8">
        ...
        <span class="sr-only">Timetable Settings</span>
      </Button>
    </PopoverTrigger>
    <PopoverContent class="w-80">
      <div class="grid gap-4">
        <div class="flex items-center justify-between">
          ...
          <Button variant="ghost" size="icon" @click="resetSettings" title="Reset to defaults">
            <RotateCcw class="h-4 w-4" />
          </Button>
        </div>
        <p class="text-sm text-muted-foreground">
          Adjust the appearance and dimensions of the timetable.
        </p>
        ...
        <div class="grid gap-2">
          ...
          <div class="grid grid-cols-3 items-center gap-4">
            <Label for="day-column-width">Day Column Width</Label>
