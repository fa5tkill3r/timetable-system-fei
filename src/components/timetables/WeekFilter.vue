    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-2">
        <h4 class="flex items-center text-sm font-medium">
          ...
          {{ $t('timetable.editor.weekFilter') }}
        </h4>
        <div class="flex gap-1">
          <Button
            size="sm"
            :variant="isFilterOddWeeksPattern ? 'default' : 'secondary'"
            class="h-7 text-xs"
          ...
          <Button
            size="sm"
            :variant="isFilterEvenWeeksPattern ? 'default' : 'secondary'"
            class="h-7 text-xs"
          ...
          <Button
            size="sm"
            :variant="isFilterAllWeeksPattern ? 'default' : 'secondary'"
            class="h-7 text-xs"
      ...
      <div class="flex justify-center gap-1">
        <button
          v-for="(active, index) in filterWeekBits"
          :key="index"
          @click="toggleFilterWeek(index)"
