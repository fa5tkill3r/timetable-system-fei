...
<template>
  ...
  >
    <div
      class="absolute right-4 top-4 flex items-center gap-2 md:right-8 md:top-8"
    >
      <LanguageSwitcher />
    </div>
    ...
    >
      ...
      <div class="relative z-20 mt-[16vh] flex flex-col items-center">
        <img
          src="/img/stu-fei.svg"
          alt="Elysa Logo"
          class="h-20 w-auto"
        ...
        <div class="grid gap-6">
          ...
          >
            ...
            <img
              src="/img/stu-fei.svg"
              alt="Google Logo"
              class="mr-2 h-7 w-auto bg-red-600 pr-1"
            />
            {{ $t('login.aisLogin') }}
          </Button>
        </div>
